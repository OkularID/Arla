...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="newsdetail" class="col-lg-11 main">
				<div class="row">
					<!-- Introduction -->
					<div class="col-lg-12 header2 mb-0" style="background-image: url('<?php the_field('background');?>');">
						<!-- Side Search -->
						...
						<div class="boxv">
							...
							<ul class="list-path">
								...
								<li><a href="<?php echo home_url('ruang-berita');?>">Ruang Berita</a></li>
					...
					<!-- <div class="col-lg-9 info"> -->
						...
						<div class="pagelist text-left mb-5">

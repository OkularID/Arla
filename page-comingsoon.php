...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-11 main comingsoon">
				<div class="row">
					<div class="cly-1">
						...
						<div class="boxv">
							...
							<div><?php the_field('brief') ?></div>
							<button class="btn-grey cly-btn">Notify me!</button>
						</div>
					</div>
					<div id="cly-2" class="cly-2">
						<ul>
							<li>
								<a href="javascript:void(0)" class="clyclosebtn">&times;</a>
							</li>
						</ul>
						<div class="boxv boxcly-2">
							<h4>
								<span>Be the first to get notified</span><br>
								when our product is ready!
							</h4>
							<?php echo do_shortcode('[contact-form-7 id="9" title="Comingsoon"]'); ?>
						</div>
						<div class="boxv boxcly-3">
							<h2><span>Thank you.</span></h2>
							<p class="moss">We will keep you updated shortly.</p>
						</div>

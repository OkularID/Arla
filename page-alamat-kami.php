...
<body>
	...
	<div class="container-fluid">
		<div class="row">
            ...
            <style type="text/css">
				#contact .side{background:#f7f5f2;}
				#contact #newsroom .info .container .item{background:#efece6;border: 10px solid #f7f5f2;}
				#contact #newsroom .info .link{margin-bottom:30px;padding:0;}
				#contact #newsroom h5{color:#2d5336;font-family:"Gilmer Bold";}
				#contact #newsroom .jurnal{padding: 60px 60px 100px;}
				#contact #newsroom .jurnal h5{margin-bottom: -20px;}
				#contact #newsroom .jurnal .video iframe{height:450px;}
				#contact #newsroom .jurnal .video iframe.vidio-embed{height: 700px;}
				@media screen and (max-width: 846px){
				    #contact #newsroom .jurnal{margin-bottom: 0;padding: 60px 10%;}
				    #contact #newsroom .jurnal .video iframe{height:auto;}
				    #contact #newsroom .jurnal .video iframe.vidio-embed{height:380px;}
				}
			</style>
			<div id="contact" class="col-lg-11 main">
				<div class="row">
					...
					<div class="col-lg-5 info">
						...
						<a class="strong-yellow" href="<?php the_field('link');?>" target="_blank"><?php the_field('link_title');?></a>
					</div>
					<div class="col-lg-4 info mp">
					...
					<div class="col-lg-3 side">
						<ul>
							<li><h5><?php the_field('title_4');?></h5></li>
					...
					<div id="newsroom" class="container-fluid">
						<div class="row">
							<!-- Info -->
							<div class="col-lg-12 info">
								<div class="link">
									<h5><?php the_field('title_2', 38);?></h5>
								</div>
								<div class="container">
									<div class="row">
										<?php

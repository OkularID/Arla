...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="about" class="col-lg-11 main">
				<div class="row">
					<!-- Introduction -->
					...
					<!-- Detail 2 -->
					<div class="col-lg-12 detail2">
						<h5><?php the_field('description_3');?></h5>
					</div>

					<!-- Detail 3 -->
					<div class="col-lg-12 detail3">
					    <h4><?php the_field('title_2');?></h4>
						<?php the_field('description_5');?>
						<!--<div class="row">-->
						<!--	<?php if(have_rows('description_4')): ?>-->
						<!--		<?php while (have_rows('description_4')): the_row(); ?>-->
